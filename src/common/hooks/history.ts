 ...
 *  差分补丁目前已知的问题是，对于预期以外的影响状态树的修改，现在都会写进历史记录，看起来就像多了一段毫None变化的历史栈一样
 *  例如Layers的 left 在修改后可能为 12.6262638 但为了输入框中Show友好，在 input Components中将自动格式化为 12.63，这个逻辑以前不会有问题，现在则不能这么做了
